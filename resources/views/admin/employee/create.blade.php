...
@section('content')
    <div class="space-y-6">
        <div class="flex items-baseline justify-between gap-3">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Tambah Karyawan</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Lengkapi informasi karyawan untuk menambah data baru ke sistem.
                </p>
            </div>
        ...
        <div class="space-y-8 rounded-3xl border border-gray-200 bg-white p-8 shadow-theme-sm dark:border-gray-800 dark:bg-gray-950/70">
            ...
            <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                @include('admin.employee._form', ['statuses' => $statuses])
