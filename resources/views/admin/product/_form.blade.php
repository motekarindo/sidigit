    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div class="space-y-5">
            <div>
                ...
                <input type="text" id="sku" wire:model.defer="sku" required
                    @class([
            ...
            <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                <div>
                    ...
                    <input type="number" step="0.01" min="0" id="base_price" wire:model.defer="base_price"
                        required
                        @class([
                            'mt-2 block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100',
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" id="sale_price" wire:model.defer="sale_price"
                        required
                        @class([
                            'mt-2 block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100',
            ...
            <div id="dimension-fields"
                @class(['grid grid-cols-1 gap-5 lg:grid-cols-2', 'hidden' => !$showDimensionFields])>
                <div>
                    <label for="length_cm" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Panjang (cm)
                    </label>
                    <input type="number" step="0.01" min="0" id="length_cm" wire:model.defer="length_cm"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" id="width_cm" wire:model.defer="width_cm"
                        @disabled(!$showDimensionFields)
                        @class([
                            'mt-2 block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100',
            ...
            <div>
                ...
                <div class="mt-3 space-y-3">
                    ...
                    <div id="product-material-select" @class(['hidden' => !$hasCategory || !$hasMaterials])>
                        <select id="materials" wire:model="materials" multiple
                            @class([
