...
@section('content')
    <div class="space-y-6">
        <div class="flex items-baseline justify-between gap-3">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Daftar Satuan</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Kelola daftar satuan yang digunakan dalam sistem.
                </p>
            </div>
            @can('unit.create')
                        ...
                        @forelse ($units as $unit)
                            <tr class="hover:bg-gray-50/60 dark:hover:bg-gray-900/50">
                                ...
                                <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                                    {{ optional($unit->created_at)->translatedFormat('d M Y H:i') ?? '-' }}
                                </td>
                                <td class="px-4 py-3">
