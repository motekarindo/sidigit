...
@section('content')
    <div class="space-y-6">
        <div class="flex items-baseline justify-between gap-3">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Daftar Supplier</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Kelola informasi supplier untuk kebutuhan pengadaan.
                </p>
            </div>
            @can('supplier.create')
                            ...
                            <tr class="hover:bg-gray-50/60 dark:hover:bg-gray-900/50">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                    <div class="flex flex-col">
                                        ...
                                        @if ($supplier->on_behalf)
                                            <span class="text-xs text-gray-500 dark:text-gray-400">a.n {{ $supplier->on_behalf }}</span>
                                        @endif
                                    </div>
                                </td>
                                <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        @endif
                                        @if ($supplier->rekening_number)
                                            <span class="inline-flex items-center gap-1 text-xs font-medium text-gray-500 dark:text-gray-400">
                                                <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M3.333 14.167h13.334M3.333 14.167V5.833c0-.92.746-1.667 1.667-1.667h10c.92 0 1.666.746 1.666 1.667v8.334M3.333 14.167l2.5-5m8.334 5-2.5-5m0 0h-5m5 0H6.667"
                                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                                {{ $supplier->rekening_number }}
                                            </span>
                                        @endif
                                    </div>
                                </td>
                                        ...
                                        @can('supplier.delete')
                                            <div x-data="{ isConfirmOpen: false }" @keydown.escape.window="isConfirmOpen = false">
                                                ...
                                                <div x-cloak x-show="isConfirmOpen" x-transition.opacity
                                                    ...
                                                    role="dialog" aria-modal="true" aria-labelledby="deleteSupplierTitle{{ $supplier->id }}"
                                                    ...
                                                    <div x-show="isConfirmOpen" x-transition.scale
                                                        ...
                                                        <div class="flex items-start gap-3">
                                                            ...
                                                            <div class="space-y-2">
                                                                <h3 id="deleteSupplierTitle{{ $supplier->id }}"
                                                                    class="text-lg font-semibold text-gray-900 dark:text-white">
                                                                    Hapus Supplier?
                                                                </h3>
                                                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                                                    Tindakan ini akan menghapus supplier
                                                                    <span class="font-semibold text-gray-900 dark:text-white">{{ $supplier->name }}</span>
                                                                    secara permanen.
                                                                </p>
                                                            </div>
                                                        </div>
