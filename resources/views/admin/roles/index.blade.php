                                            ...
                                            <div x-data="{ isConfirmOpen: false }" @keydown.escape.window="isConfirmOpen = false">
                                                <form x-ref="formDeleteRole{{ $role->id }}"
                                                    ...
                                                    <div x-cloak x-show="isConfirmOpen" x-transition.opacity
                                                        ...
                                                        role="dialog" aria-modal="true" aria-labelledby="deleteRoleTitle{{ $role->id }}"
                                                        ...
                                                        <div x-show="isConfirmOpen" x-transition.scale
                                                            ...
                                                            <div class="flex items-start gap-3">
                                                                ...
                                                                <div class="space-y-2">
                                                                    <h3 id="deleteRoleTitle{{ $role->id }}"
                                                                        class="text-lg font-semibold text-gray-900 dark:text-white">
                                                                        Hapus Role?
                                                                    </h3>
                                                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                                                        Tindakan ini akan menghapus role
                                                                        <span class="font-semibold text-gray-900 dark:text-white">{{ $role->name }}</span>
                                                                        secara permanen. Pastikan role ini tidak lagi dibutuhkan.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="mt-6 flex items-center justify-end gap-2">
                                                                ...
                                                                <button type="button"
                                                                    @click="$refs.formDeleteRole{{ $role->id }}.submit()"
