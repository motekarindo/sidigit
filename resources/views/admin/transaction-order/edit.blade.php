...
@section('title', 'Edit Transaksi Order')

@section('content')
    <div class="space-y-6">
        <div class="flex items-baseline justify-between gap-3">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit Transaksi Order</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Perbarui detail pesanan, item bahan, dan riwayat pembayaran.
                </p>
            </div>
        ...
        <div
            ...
            <form action="{{ route('transaction-orders.update', $order) }}" method="POST" class="space-y-8" id="transaction-order-form">
                @csrf
                @method('PUT')
