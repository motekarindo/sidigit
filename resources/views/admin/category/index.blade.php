...
@section('content')
    <div class="space-y-6">
        <div class="flex items-baseline justify-between gap-3">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Daftar Kategori</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Kelola daftar kategori yang digunakan pada sistem.
                </p>
            </div>
            @can('category.create')
                        ...
                        @forelse ($categories as $category)
                            <tr class="hover:bg-gray-50/60 dark:hover:bg-gray-900/50">
                                ...
                                <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                                    {{ optional($category->created_at)->translatedFormat('d M Y H:i') ?? '-' }}
                                </td>
                                <td class="px-4 py-3">
                                        ...
                                        @can('category.delete')
                                            <div x-data="{ isConfirmOpen: false }" @keydown.escape.window="isConfirmOpen = false">
                                                ...
                                                <div x-cloak x-show="isConfirmOpen" x-transition.opacity
                                                    ...
                                                    role="dialog" aria-modal="true" aria-labelledby="deleteCategoryTitle{{ $category->id }}"
                                                    ...
                                                    <div x-show="isConfirmOpen" x-transition.scale
                                                        ...
                                                        <div class="flex items-start gap-3">
                                                            ...
                                                            <div class="space-y-2">
                                                                <h3 id="deleteCategoryTitle{{ $category->id }}"
