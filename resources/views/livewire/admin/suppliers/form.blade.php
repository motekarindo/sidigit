<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
    <div class="space-y-4">
        <x-forms.input label="Nama Supplier" name="form.name" placeholder="Nama supplier" wire:model.blur="form.name"
            required />

        <x-forms.input label="Atas Nama (Opsional)" name="form.on_behalf" placeholder="Atas nama"
            wire:model.blur="form.on_behalf" />

        <x-forms.input label="Industri" name="form.industry" placeholder="Industri" wire:model.blur="form.industry"
            required />
    ...
    <div class="space-y-4">
        <x-forms.input label="Email (Opsional)" name="form.email" placeholder="Email" wire:model.blur="form.email"
            type="email" />
        ...
        <div>
            <livewire:components.text-editor label="Alamat (Opsional)" placeholder="Tulis alamat supplier"
