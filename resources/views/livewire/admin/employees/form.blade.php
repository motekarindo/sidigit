<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
    <div class="space-y-4">
        <x-forms.input label="Nama Lengkap" name="form.name" placeholder="Nama lengkap"
            wire:model.blur="form.name" />

        <div>
            <label class="text-sm font-medium text-gray-700 dark:text-gray-200">Status</label>
            <select wire:model.blur="form.status" class="form-input mt-2">
        ...
        <x-forms.input label="Gaji (Rp)" name="form.salary" placeholder="0"
            wire:model.blur="form.salary" type="number" min="0" />
    </div>
