<div class="space-y-6">
    <div class="flex items-baseline justify-between gap-3">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tentukan nama peran, slug, serta hak aksesnya.</p>
        </div>
        ...
        <form wire:submit.prevent="save" class="space-y-8">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">Centang menu dan izin yang boleh diakses role ini.</p>
                </div>
