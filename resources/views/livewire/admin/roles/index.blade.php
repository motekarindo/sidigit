<div class="space-y-6">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div class="relative">
                <input type="search" wire:model.debounce.400ms="search" placeholder="Cari nama atau slug role"
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm dark:divide-gray-800">
                <thead class="bg-gray-50 dark:bg-gray-900/50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Nama Role</th>
                ...
                <tbody class="divide-y divide-gray-100 bg-white dark:divide-gray-900 dark:bg-gray-950/40">
                    @forelse ($roles as $role)
                        <tr class="hover:bg-gray-50/60 dark:hover:bg-gray-900/50" wire:key="role-{{ $role->id }}">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    @can('role.delete')
                                        <button type="button"
                                            x-data="{}"
                                            x-on:click.prevent="if (confirm('Hapus role {{ $role->name }}?')) $wire.deleteRole({{ $role->id }});"
