...
class WarehouseController extends Controller
{
    ...
    public function store(WarehouseRequest $request)
    {
        ...
        try {
            ...
            return back()
                ->withInput()
                ->with('error', ErrorReporter::report($th, 'Terjadi kesalahan saat menambahkan gudang.')['message']);
        }
    }
    ...
    public function update(WarehouseRequest $request, int $warehouse)
    {
        ...
        try {
            ...
            return back()
                ->withInput()
                ->with('error', ErrorReporter::report($th, 'Terjadi kesalahan saat memperbarui data gudang.')['message']);
        }
    }
