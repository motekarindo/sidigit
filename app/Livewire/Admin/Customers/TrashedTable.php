...
class TrashedTable extends BaseTable
{
    ...
    {
        // No modal form for trashed customers.
    }
    ...
    public function restore(int $id): void
    {
        try {
            ...
            report($e);
            $this->dispatch('toast', message: 'Gagal memulihkan pelanggan.', type: 'error');
        }
    }
    ...
    public function bulkRestore(): void
    {
        ...
        try {
            ...
            $this->dispatch('toast', message: 'Pelanggan terpilih berhasil dipulihkan.', type: 'success');
        } catch (\Throwable $e) {
            report($e);
            $this->dispatch('toast', message: 'Gagal memulihkan pelanggan terpilih.', type: 'error');
        }
    }
